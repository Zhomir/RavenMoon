...
<form method="post" action="prodautho.php" name="signup-form">
    ...
    <div class="acontain">
        <div class="box-profile">
            <h1 class="namebar-center">Авторизация продюсера</h1>
            <div class="field-content">
                ...
                <div class="button">
                    <button class="size" button type="submit">Войти</button>
                </div>
                <div class="text">
                    <p>Если у вас нет учетной записи, то вы можете</p>
                    <a href="prodreg.php"> Зарегистрироваться </a>
                </div>
            </div>
        </div>
</body>
