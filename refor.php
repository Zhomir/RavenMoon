...
<form method="post" action="reformation.php" name="signup-form">
    ...
    <div class="acontain">
        <div class="box-profile">
            <h1 class="namebar-center">Изменение личных данных</h1>
            <div class="field-content">
                ...
                <div class="button">
                    <button class="size" button type="submit" name="reformation" value="reformation">Изменить данные</button>
                </div>
            </div>
        </div>
</body>
