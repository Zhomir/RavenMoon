...
if (isset($_POST['register'])) {
    ...
    $query = $connection->prepare("SELECT * FROM userp WHERE mail=:mail");
    ...
    if ($query->rowCount() == 0) {
        $query = $connection->prepare("INSERT INTO userp(FIO,Mail,Birthday,Login,Passw,EDUCATION,Numberphone,Specification) VALUES (:FIO,:mail,:birthday,:login, :password_hash,:education,:numberphone,:specification)");
